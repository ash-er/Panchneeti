...
def store_data_in_mysql(data_dict):
    ...
    try:
        ...
        cursor.execute('TRUNCATE TABLE TwitterTrendWordCloud')

        for key, value in data_dict.items():
            cursor.execute('''
                INSERT INTO TwitterTrendWordCloud (key_, value) VALUES (%s, %s)
...
if __name__ == '__main__':
    ...
    # result_trend = get_normalized_WRDCLD()
    #
    # print("WordCloud Dictionary Successfully Fetched: ", result_trend)
    #
    # store_data_in_mysql(result_trend)
